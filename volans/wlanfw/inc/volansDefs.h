 ...
 *  @file:         volansDefs.h
 *
 *  @brief:        This file volansDefs.h contains the Libra hardware related definitions.
 *
...
/* BMU */
/* --------------------------------------------------------------------- */
#define BMU_COMMAND_BASE_ADDRESS    0x0F000000  // got this from Volans map: 0f00_0000
...
#define RXP_VERSION                   0 /*QWLAN_RXP_FRAME_FILTER_CONFIG_VERSION_CHECK_ENABLE_MASK*/
#define RXP_NAV_SET                   0 /*QWLAN_RXP_FRAME_FILTER_CONFIG_NAV_SET_ENABLE_MASK*/
#define RXP_NAV_CLEAR                 0 /*QWLAN_RXP_FRAME_FILTER_CONFIG_NAV_CLEAR_ENABLE_MASK*/
#define RXP_FCS                       0 /*QWLAN_RXP_FRAME_FILTER_CONFIG_FCS_FILTER_ENABLE_MASK*/
...
//can define chip revisions here
...
typedef enum
{
	...
	DMA_CHANNEL_RX_HI = DMA_CHANNEL_3,
}eDMAChannel;
...
/*
 * BMU WQ assignment, as per Volans Programmer's Guide
 *
 */
...
#define ADU_REG_BKUP_POLL_CMD  0xA0000000
#define ADU_BATCH_REG_BKUP_CMD  0xB0000000
#define ADU_BITMAP_REG_BKUP_CMD 0xC0000000

#define ADU_CMD_TYPE_MASK 0xF0000000

#define ADU_BATCH_REG_BKUP_CMD_HEADER_SIZE 8
#define ADU_BATCH_REG_BKUP_CMD_NUM_REG_MASK 0xFF
#define ADU_BATCH_REG_BKUP_CMD_NUM_REG_OFFSET 0

#define ADU_REG_BKUP_POLL_CMD_START_BIT_OFFSET_OFFSET 0x0
#define ADU_REG_BKUP_POLL_CMD_START_BIT_OFFSET_MASK   0x0000001F
#define ADU_REG_BKUP_POLL_CMD_NUM_BITS_OFFSET 0x5
#define ADU_REG_BKUP_POLL_CMD_NUM_BITS_MASK   0x000001E0
#define ADU_REG_BKUP_POLL_CMD_RETRY_TIMEOUT_OFFSET 0x9
#define ADU_REG_BKUP_POLL_CMD_RETRY_TIMEOUT_MASK   0x0000FE00
