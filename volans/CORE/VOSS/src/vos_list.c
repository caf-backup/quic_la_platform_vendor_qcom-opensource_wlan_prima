...
/*
// need to revisit this code since I have dispensed with vos_data_buf_desc_t and vos_pkt_buf_desc_t 
VOS_STATUS vos_list_remove_front_data_buf( vos_list_t *pList, vos_data_buf_desc_t **ppNode )
{
   ...
   spin_lock_irqsave(&pList->lock, flags);
         
   if ( pList->cookie != VOS_LIST_COOKIE )
   {
      spin_unlock_irqrestore(&pList->lock, flags);
      return VOS_STATUS_E_INVAL;
   }
   ...
   *ppNode = list_entry( listptr, vos_data_buf_desc_t, list );
...
VOS_STATUS vos_list_remove_front( vos_list_t *pList, vos_list_node_t **ppNode )
{
   ...
   if ( list_empty( &pList->anchor ) )
   {
      VOS_TRACE(VOS_MODULE_ID_VOSS, VOS_TRACE_LEVEL_WARN, "%s: list empty", __FUNCTION__);
      mutex_unlock(&pList->lock);
      return VOS_STATUS_E_EMPTY;
   }
...
// need to revisit this code since I have dispensed with vos_data_buf_desc_t and vos_pkt_buf_desc_t 
/*
VOS_STATUS vos_list_remove_back_data_buf( vos_list_t *pList, vos_data_buf_desc_t **ppNode )
{
   struct list_head * listptr;
   unsigned long flags;
...
/*----------------------------------------------------------------------------
  ...
  --------------------------------------------------------------------------*/  
/*
VOS_STATUS vos_list_peek_front_data_buf( vos_list_t *pList, vos_data_buf_desc_t **ppNode )
{
   struct list_head * listptr;
   unsigned long flags;
...
/*----------------------------------------------------------------------------
  ...
  --------------------------------------------------------------------------*/  
/*
VOS_STATUS vos_list_peek_back_data_buf( vos_list_t *pList, vos_data_buf_desc_t **ppNode )
{
   struct list_head * listptr;
   unsigned long flags;
...
/*----------------------------------------------------------------------------
  ...
  *not* be removed from the list.
  ...
  --------------------------------------------------------------------------*/  
/*
VOS_STATUS vos_list_peek_next_data_buf( vos_list_t *pList, vos_data_buf_desc_t *pNode,
                               vos_data_buf_desc_t **ppNode )
{
   struct list_head * listptr;
   unsigned long flags;
...
/*----------------------------------------------------------------------------
  ...
  *not* be removed from the list.
  ...
  --------------------------------------------------------------------------*/                                 
/*
VOS_STATUS vos_list_peek_prev_data_buf( vos_list_t *pList, vos_data_buf_desc_t *pNode, 
                               vos_data_buf_desc_t **ppNode )
{
   struct list_head * listptr;
   unsigned long flags;
