 ...
 *
 * FUNCTION:
 * This returns the actual rate given the MAC rate encoding
 *
 * LOGIC:
 *
 * ASSUMPTIONS:
 ...
 * NOTE:
 *
 * @param  macRate rate in MAC encoding
 * @return actual rate
 */

static inline tANI_U8
sirMacRate2Actual(tANI_U8 macRate)
{
#if 0
    switch (macRate)
    {
 ...
 *
 * FUNCTION:
 * This returns the MAC rate encoding given the phy mode and rate
 *
 * LOGIC:
 *
 * ASSUMPTIONS:
 ...
 * NOTE:
 *
 * @param phyRate PHY rate encoding
 * @param phyMode PHY mode encoding
 * @return MAC rate encoding
 */

static inline tANI_U8
sirPhyRate2MacRate(tANI_U8 phyRate, tANI_U8 phyMode)
{
#if 0
    switch (phyMode)
    {
        case HAL_PHY_MODE_11A:
        case HAL_PHY_MODE_11G:
            switch (phyRate)
            {
                case HAL_PHY_RATE_6:
                    return SIR_MAC_RATE_6;
                case HAL_PHY_RATE_9:
                    return SIR_MAC_RATE_9;
                case HAL_PHY_RATE_12:
                    return SIR_MAC_RATE_12;
                case HAL_PHY_RATE_18:
                    return SIR_MAC_RATE_18;
                case HAL_PHY_RATE_24:
                    return SIR_MAC_RATE_24;
                case HAL_PHY_RATE_36:
                    return SIR_MAC_RATE_36;
                case HAL_PHY_RATE_48:
                    return SIR_MAC_RATE_48;
                case HAL_PHY_RATE_54:
                    return SIR_MAC_RATE_54;
            }
            break;

        case HAL_PHY_MODE_11A_MIMO:
        case HAL_PHY_MODE_11G_MIMO:
            switch (phyRate)
            {
                case HAL_PHY_RATE_MIMO_72:
                    return SIR_MAC_RATE_72;
                case HAL_PHY_RATE_MIMO_96:
                    return SIR_MAC_RATE_96;
                case HAL_PHY_RATE_MIMO_108:
                    return SIR_MAC_RATE_108;

            }
            break;

        case HAL_PHY_MODE_11B_LONG:
        case HAL_PHY_MODE_11B_SHORT:
            switch (phyRate)
            {
                case HAL_PHY_RATE_1:
                    return SIR_MAC_RATE_1;
                case HAL_PHY_RATE_2:
                    return SIR_MAC_RATE_2;
                case HAL_PHY_RATE_5_5:
                    return SIR_MAC_RATE_5_5;
                case HAL_PHY_RATE_11:
                    return SIR_MAC_RATE_11;
            }
    }
#endif
