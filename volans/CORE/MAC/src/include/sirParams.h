...
typedef enum eSriLinkState {
    ...
    eSIR_LINK_LEARN_STATE       = 5,
    eSIR_LINK_SCAN_STATE        = 6,
    eSIR_LINK_FINISH_SCAN_STATE = 7,
    eSIR_LINK_INIT_CAL_STATE    = 8,
    eSIR_LINK_FINISH_CAL_STATE  = 9
} tSirLinkState;
...
//106,107 ... Slots are Free for use.
...
#define SIR_LIM_ADDR2_MISS_IND             SIR_HAL_ITC_MSG_TYPES_BEGIN + 141
#endif
