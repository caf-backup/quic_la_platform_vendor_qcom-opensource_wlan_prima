...
typedef struct sAniSirLim
{
    ...
    tpSirSmeStartBssReq   gpLimStartBssReq;
    ...
    // SIR_HAL_ADD_BSS_RSP here.
    //
    // For now:
    // This will be used during SIR_HAL_SET_BSSKEY_REQ in
    ...
    // received by SME state machine
    tpSirSmeReassocReq    gpLimReassocReq;
