...
/*----------------------------------------------------------------------------------
    \fn palOpen
    \brief To initial the OS dependent routine for access the chip. Allocate necessary
           resources.
    \param hHdd - HDD context handle
    
    \return eHalStatus - Note that this function can fail.
----------------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------------
    \fn palClose
    \brief To uninitial the OS dependent routine for access the chip. Deallocate necessary
           resources.
    \param hHdd - HDD context handle
...
/*----------------------------------------------------------------------------------
    \fn palPreStart
    \brief this function is to stop the operation. After the function returns, the driver is ready to
    access any HW related system calls(e.g. access register, device memory, shared memory).
...
/*----------------------------------------------------------------------------------
    \fn palPostStart
    \brief This function is called after the HW has been initialized for normal operation. After the  
    function returns, the driver is ready to start receiving interrupts and send/receive traffic on the data path.
...
/*----------------------------------------------------------------------------------
    \fn palStop
    \brief this function is to stop the operation. After the function is called, the driver cannot
    access any HW related system calls(e.g. access register, device memory, shared memory).
...
/*----------------------------------------------------------------------------------
    \fn palStartHdd
    \brief this function is to invoke the HDD to start routines that it deems necessary.
...
/*----------------------------------------------------------------------------------
    \fn palStopHdd
    \brief this function is to invoke the HDD to stop routines that it deems necessary.
