...
tAhbPri ahbPriList[] = {
    ...
    {QWLAN_CAHB_CAHB_DBR_PL_REG, QWLAN_CAHB_CAHB_DBR_PL_PRIORITY_OFFSET, QWLAN_CAHB_CAHB_DBR_PL_PRIORITY_MASK, 7},        
    ...
    {QWLAN_DAHB_DAHB_JTAG_PL_REG, QWLAN_DAHB_DAHB_JTAG_PL_PRIORITY_OFFSET, QWLAN_DAHB_DAHB_JTAG_PL_PRIORITY_MASK, 7}
 };
