...
//#define MAX_TEST_WAVEFORM_SAMPLES 1024
/* This value is being changed to address compilation issues on Android
 * Need to remove this variable from stack
 */
...
extern const tWaveformSample pWave[1024];
