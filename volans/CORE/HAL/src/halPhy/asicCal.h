...
#else
#define CAL_MODE_ENORMAL 0
#define CAL_MODE_EINITDCCAL 0
#define CAL_MODE_ERESDCCAL 0
#define CAL_MODE_EIQCAL 0
#define CAL_MODE_ETXLOCAL 0
#endif

#define CAL_MEM                         QWLAN_CAL_IQ_CORR_COEFF_MEM_MREG
#define CAL_MEM_PHASE_VAL_WIDTH         (9)                             //each value is 9 bits wide
#define CAL_MEM_CHAIN_MULT              (3 * CAL_MEM_PHASE_VAL_WIDTH)   //each chain takes 27 bits
#define CAL_MEM_GAIN_MULT               (8)                            //gain indexes are on 16 byte boundaries
