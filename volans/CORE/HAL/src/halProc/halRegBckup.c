...
tRegisterEntry aVolansRFSetup[] = {
    ...
    { (QWLAN_AGC_INIT_GAIN_REG | HAL_REG_RSVD_BIT | HAL_REG_HOST_FILLED), 0x47 },
    { (QWLAN_AGC_MAX_GAIN_REG | HAL_REG_RSVD_BIT | HAL_REG_HOST_FILLED), 0x49 },
    { (QWLAN_CAL_DEBUG_OUTPUT_EN_MASK_REG | HAL_REG_RSVD_BIT | HAL_REG_HOST_FILLED), 0x0 },
    { (QWLAN_TXCTL_RFIF_TR_REG | HAL_REG_RSVD_BIT | HAL_REG_HOST_FILLED), 0x3c },
    { (QWLAN_AGC_D_TX_SETTLE1_REG | HAL_REG_RSVD_BIT | HAL_REG_HOST_FILLED), 0x190 },
    { (QWLAN_AGC_D_TX_SETTLE2_REG | HAL_REG_RSVD_BIT | HAL_REG_HOST_FILLED), 0x10 },
    { (QWLAN_AGC_TH_DCO_CAL_REG | HAL_REG_RSVD_BIT | HAL_REG_HOST_FILLED), 0x18 },
#endif /* VOLANS_FPGA */

#ifdef VOLANS_RF
    { (QWLAN_RFIF_GC_CFG_REG | HAL_REG_RSVD_BIT | HAL_REG_HOST_FILLED), 0x0 },
    
    { (QWLAN_RFAPB_HDET_CTL_REG | HAL_REG_RSVD_BIT | HAL_REG_HOST_FILLED), 0x286 },
    { (QWLAN_RFAPB_TX_LO_MIX_DA_ADJ_REG | HAL_REG_RSVD_BIT | HAL_REG_HOST_FILLED), 0x90d0 },

	/* Process Monitor */
	{ (QWLAN_RFAPB_TCXO_REG4_REG | HAL_REG_RSVD_BIT | HAL_REG_FW_FILLED), 0 },   // this needs to be done before PLL enable
	{ (QWLAN_RFAPB_PLL_AC_REG5_REG | HAL_REG_RSVD_BIT | HAL_REG_FW_FILLED), 0x5988 }, // this needs to be done before PLL enable
	{ (QWLAN_RFAPB_PLL_AC_REG1_REG | HAL_REG_RSVD_BIT | HAL_REG_FW_FILLED), 0x22 }, // this needs to be done before PLL enable
	{ (QWLAN_RFAPB_PLL_AC_REG3_REG | HAL_REG_RSVD_BIT | HAL_REG_FW_FILLED), 0x7c30 }, // this needs to be done before PLL enable
	{ (QWLAN_RFAPB_BBF_CTL3_REG | HAL_REG_RSVD_BIT | HAL_REG_FW_FILLED), 0 },
	{ (QWLAN_RFAPB_BBF_CTL4_REG | HAL_REG_RSVD_BIT | HAL_REG_FW_FILLED), 0 },
	{ (QWLAN_RFAPB_BBF_AUX2_REG | HAL_REG_RSVD_BIT | HAL_REG_FW_FILLED), 0 },

    { (QWLAN_RFAPB_TX_LO_MIX_DA_ADJ_REG | HAL_REG_RSVD_BIT | HAL_REG_HOST_FILLED), 0x9080 },
    { (QWLAN_RFAPB_LNA_BYPASS_CFF_CTL_REG | HAL_REG_RSVD_BIT | HAL_REG_HOST_FILLED), 0x2b53 },
...
tRegisterEntry aVolansPhyRFTxSetup[] = 
{
	...
	{ ((QWLAN_TXFIR_DPD_MEM0_MREG + 2044) | HAL_REG_RSVD_BIT | HAL_REG_FW_FILLED), 0x0 },
#endif // VOLANS_FPGA
	{ (QWLAN_BMU_DISABLE_WQ_DA_REG | HAL_REG_RSVD_BIT | HAL_REG_HOST_FILLED), 0x0 },
