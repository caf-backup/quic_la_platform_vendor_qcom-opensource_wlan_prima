...
tRegisterEntry aVolansRFSetup[] = {
    ...
    { (QWLAN_TXCTL_WATCHDOG_TX_REG | HAL_REG_RSVD_BIT | HAL_REG_FW_FILLED), 0x4E20 },
    ...
    { (QWLAN_AGC_SAT_DELAY_REG | HAL_REG_RSVD_BIT | HAL_REG_FW_FILLED), 10 },
    { (QWLAN_AGC_SIFS_TIME_B_REG | HAL_REG_RSVD_BIT | HAL_REG_FW_FILLED), 80 },
    { (QWLAN_AGC_SIFS_TIME_A_REG | HAL_REG_RSVD_BIT | HAL_REG_FW_FILLED), 80 },
    { (QWLAN_AGC_RSSI_OFFSET0_REG | HAL_REG_RSVD_BIT | HAL_REG_FW_FILLED), 56 },
    ...
    { (QWLAN_RFAPB_RX_GC_127_REG | HAL_REG_RSVD_BIT | HAL_REG_FW_FILLED), 0x11e },
    { (QWLAN_RFAPB_RX_DCOC_EN0_REG | HAL_REG_RSVD_BIT | HAL_REG_FW_FILLED), 0xffff },
    { (QWLAN_RFAPB_RX_DCOC_EN1_REG | HAL_REG_RSVD_BIT | HAL_REG_FW_FILLED), 0xffff },
    ...
    /* IM2 */
    { (QWLAN_RFAPB_RX_IM2_SPARE0_REG | HAL_REG_RSVD_BIT | HAL_REG_FW_FILLED), 0 },
    { (QWLAN_RFAPB_RX_IM2_SPARE1_REG | HAL_REG_RSVD_BIT | HAL_REG_FW_FILLED), 0 },
...
tRegisterEntry PostBmuStartRegList[] = {
	...
	{ (QWLAN_BMU_BTQM_CONTROL1_REG | HAL_REG_RSVD_BIT | HAL_REG_HOST_FILLED), ~QWLAN_BMU_BTQM_CONTROL1_FAST_STA_MEM_INIT_MASK },
	{ (QWLAN_BMU_BTQM_CONTROL2_REG | HAL_REG_RSVD_BIT | HAL_REG_HOST_FILLED), TX_QID_ENABLE | QWLAN_BMU_BTQM_CONTROL2_CFG_BA_PARTIAL_BITMAP_UPDATE_MASK },
#ifndef WLAN_SOFTAP_FEATURE
	{ (QWLAN_BMU_BTQM_CONTROL1_REG | HAL_REG_RSVD_BIT | HAL_REG_HOST_FILLED), 0xf },
#else
  { (QWLAN_BMU_BTQM_CONTROL1_REG | HAL_REG_RSVD_BIT | HAL_REG_HOST_FILLED), 0x0200801f },
  { (QWLAN_BMU_BTQM_ERR_ENABLE_REG | HAL_REG_RSVD_BIT | HAL_REG_FW_FILLED), 0x0 },
#endif
    ...
    { (QWLAN_RXP_CONFIG4_REG | HAL_REG_RSVD_BIT | HAL_REG_FW_FILLED), 0x0 },
	{ (QWLAN_RXP_ROUTING_FLAG_REG | HAL_REG_RSVD_BIT | HAL_REG_FW_FILLED), 0x0 },
