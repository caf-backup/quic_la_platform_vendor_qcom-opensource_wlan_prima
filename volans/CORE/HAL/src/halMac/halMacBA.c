    ...
    tpDelBAParams pDelBAParams)
{
	 ...
	 */
        ...
        rpeStaQueueInfo.staId_queueId_Reorderbitmap = 0;
#endif
    ...
    tANI_U8 baBufferSize )
{
        ...
        sizeof( tAddBAInd )))
  {
    ...
    pAddBAInd->baSession.winSize = baBufferSize;
        ...
        if(pAddBAParams)
        {
			...
			/* FIXME_GEN6: BA window size should be coming from the TL response message */
		        ...
		        rpeStaQueueInfo.ssn_sval = 0;
                        ...
                        rpeStaQueueInfo.reorder_ssn = rpeStaQueueInfo.ba_ssn + (rpeStaQueueInfo.staId_queueId_BAbitmap & 1);
#else
