...
/* FIXME */
/* The change has been made to support PMU extended wakeup times
 * These wakeup times are going to be used to address the issues
 * while chip wakeup. This is a "workaround" ONLY and MUST be 
 * reverted back to normal values AS SOON AS POSSIBLE
 */
...
#define HAL_PWR_SAVE_FW_BMPS_SLEEP_TIME_OVERHEADS_WITHOUT_RFXO_SETTLING_US  1248
#else
//FPGA values
#define HAL_PWR_SAVE_FW_BMPS_SLEEP_TIME_OVERHEADS_RFXO_US                   8000 
#define HAL_PWR_SAVE_FW_FORCED_SLEEP_TIME_OVERHEADS_RFXO_US                 8000
#define HAL_PWR_SAVE_FW_BMPS_SLEEP_TIME_OVERHEADS_RFXO_US_19_2              7652 /* FIXME */ 
