        ...
        tANI_U32 beaconInterval, tANI_U8 enable_flag)
{
   ...
   HALLOGE(halLog(pMac, LOGE, FL("\n[SoftApFwBcnTx-ERROR]-halMTU_EnableDisableBssidTBTTBeaconTransmission called...\n")));
#endif
...
#if WLAN_SOFTAP_FW_BEACON_TRANSMIT
   HALLOGE( halLog(pMac, LOGE, FL("[SoftApFwBcnTx-ERROR]-halInitPreBeaconTmr Enter... \n")));
#endif
...
#if WLAN_SOFTAP_FW_BEACON_TRANSMIT
   HALLOGE( halLog(pMac, LOGE, FL("[SoftApFwBcnTx-ERROR]-halIntMtuHandlePreBeaconTmr Enter... \n")));
#endif
