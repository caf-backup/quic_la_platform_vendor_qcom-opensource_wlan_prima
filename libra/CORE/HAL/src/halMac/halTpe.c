                                    ...
                                    tANI_U32 tpe_beacon_template_offset)
{
	...
	/** Zero out the TPE Beacon template address */
    halZeroDeviceMemory(pMac, pMac->hal.memMap.probeRespTemplate_offset,
            (pMac->hal.memMap.probeRespTemplate_size * pMac->hal.memMap.maxBssids));
#endif
 ...
 *
 * \param dWord0    Pointer to strore word0
 *
 * \param dWord1    Pointer to strore word1
 *
 * \return eHalStatus Rate table reterival status
 */
 ...
 * \param tableAddr Index of the rate table
 *
 * \param dWord0    word0 to write to rate table
 *
 * \param dWord1    word1 to write to rate table
 *
