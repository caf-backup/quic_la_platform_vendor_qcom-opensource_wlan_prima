...
tRxpFilterConfig rxpFilterTable_AllMode[] = {
    ...
    {eMGMT_REASSOC_RSP,          (RXP_VERSION|RXP_NAV_SET|RXP_FCS|RXP_ADDR1_BLOCK_BROADCAST|RXP_ADDR1_BLOCK_MULTICAST|
                                  RXP_ADDR1_FILTER|RXP_ACCEPT_ALL_ADDR2|RXP_ACCEPT_ALL_ADDR3) },
#if 1//WLAN_SOFTAP_FW_PROCESS_PROBE_REQ_FEATURE
    {eMGMT_PROBE_REQ,            (RXP_VERSION|RXP_NAV_SET|RXP_ADDR1_ACCEPT_MULTICAST|RXP_ADDR1_FILTER|RXP_ADDR1_ACCEPT_UNICAST|RXP_ACCEPT_ALL_ADDR2|RXP_FCS) },
#else 
    {eMGMT_PROBE_REQ,            (RXP_VERSION|RXP_NAV_SET|RXP_ADDR1_BLOCK_BROADCAST|RXP_ADDR1_BLOCK_MULTICAST|RXP_ADDR1_FILTER|RXP_ADDR1_ACCEPT_UNICAST|RXP_ACCEPT_ALL_ADDR2|RXP_FCS) },
#endif
    ...
    {eCTRL_PSPOLL,               (RXP_VERSION|RXP_ADDR1_FILTER|RXP_ADDR1_ACCEPT_UNICAST|RXP_ADDR1_BLOCK_BROADCAST|RXP_ADDR1_BLOCK_MULTICAST|RXP_ADDR2_FILTER|RXP_FCS) },
...
#endif
        halWriteRegister(pMac, QWLAN_RXP_BEACON_ADDR2_LOW_FIELD_REG, 
			                                  (tANI_U32)bssidLo);
        halWriteRegister(pMac, QWLAN_RXP_BEACON_ADDR2_HIGH_FIELD_REG, 
			                                  (tANI_U32)bssidHi);
