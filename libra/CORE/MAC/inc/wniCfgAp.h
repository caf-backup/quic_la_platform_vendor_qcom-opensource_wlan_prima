...
#define WNI_CFG_ENABLE_PHY_AGC_LISTEN_MODE_STAMAX    1
#define WNI_CFG_ENABLE_PHY_AGC_LISTEN_MODE_STADEF    0

#define WNI_CFG_ENABLE_PHY_AGC_LISTEN_MODE_APMIN    0
#define WNI_CFG_ENABLE_PHY_AGC_LISTEN_MODE_APMAX    1
#define WNI_CFG_ENABLE_PHY_AGC_LISTEN_MODE_APDEF    0

#define CFG_PARAM_MAX_NUM         217
#define CFG_AP_IBUF_MAX_SIZE      162
#define CFG_AP_SBUF_MAX_SIZE      2119
#define CFG_STA_IBUF_MAX_SIZE     157
