/*===========================================================================
  ...
  This implementation is specific to Android and BM3 Bluetooth Stack
...
#define BTC_INFO_ARG1(...) LOGI(__VA_ARGS__)
#define BTC_INFO_ARG3(...) LOGI(__VA_ARGS__)
#define BTC_ERR(...)       LOGE(__VA_ARGS__)
#define BTC_ERR_ARG1(...)  LOGE(__VA_ARGS__)
                              ...
                              void *user_data)
{
   ...
   */
   ...
   /* print out the event contents */
   {
      ...
      BTC_INFO_ARG1("BTC-SVC: event type (%d)", btEvent->ev);
      if (event_data != NULL)
      {
        ...
        for (local_index = 0; local_index < sizeof(btEvent->u); local_index++)
        {
          ...
          BTC_INFO_ARG3("  [%02d] 0x%02x (%d)", local_index, local_byte, local_byte);
        }
      }
   }
#endif // BTC_DEBUG
