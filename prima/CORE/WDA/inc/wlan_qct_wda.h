...
#define WDA_START_INNAV_MEAS_REQ       SIR_HAL_START_INNAV_MEAS_REQ 
#define WDA_START_INNAV_MEAS_RSP       SIR_HAL_START_INNAV_MEAS_RSP
#define WDA_FINISH_INNAV_MEAS_REQ      SIR_HAL_FINISH_INNAV_MEAS_REQ
#endif
#endif
