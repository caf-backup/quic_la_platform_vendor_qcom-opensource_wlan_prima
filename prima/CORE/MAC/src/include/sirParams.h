...
#define SIR_HAL_SIGNAL_BTAMP_EVENT	SIR_HAL_ITC_MSG_TYPES_BEGIN + 150
...
#define SIR_HAL_CFG_RXP_FILTER_REQ         SIR_HAL_ITC_MSG_TYPES_BEGIN + 154
#define SIR_HAL_CFG_RXP_FILTER_RSP         SIR_HAL_ITC_MSG_TYPES_BEGIN + 155

#define SIR_HAL_CFG_APPS_CPU_WAKEUP_STATE_REQ  SIR_HAL_ITC_MSG_TYPES_BEGIN + 156
#define SIR_HAL_CFG_APPS_CPU_WAKEUP_STATE_RSP  SIR_HAL_ITC_MSG_TYPES_BEGIN + 157

#if defined WLAN_FEATURE_VOWIFI_11R
#define SIR_HAL_AGGR_QOS_REQ               SIR_HAL_ITC_MSG_TYPES_BEGIN + 158
#define SIR_HAL_AGGR_QOS_RSP               SIR_HAL_ITC_MSG_TYPES_BEGIN + 159
#endif /* WLAN_FEATURE_VOWIFI_11R */

#ifdef WLAN_FEATURE_P2P
/* PE <-> HAL P2P msg */
#define SIR_HAL_SET_P2P_GO_NOA_REQ          SIR_HAL_ITC_MSG_TYPES_BEGIN + 160
#endif
