...
#define SIR_HAL_RMC_BECOME_LEADER          (SIR_HAL_ITC_MSG_TYPES_BEGIN + 209)
#define SIR_HAL_RMC_LEADER_SELECT_RESP     (SIR_HAL_ITC_MSG_TYPES_BEGIN + 210)
#define SIR_HAL_RMC_LEADER_REQ             (SIR_HAL_ITC_MSG_TYPES_BEGIN + 211)
#define SIR_HAL_RMC_UPDATE_IND             (SIR_HAL_ITC_MSG_TYPES_BEGIN + 212)
