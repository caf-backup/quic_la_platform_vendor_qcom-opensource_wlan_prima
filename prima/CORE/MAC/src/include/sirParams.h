...
#define SIR_HAL_CFG_APPS_CPU_WAKEUP_STATE_REQ  SIR_HAL_ITC_MSG_TYPES_BEGIN + 157
#define SIR_HAL_CFG_APPS_CPU_WAKEUP_STATE_RSP  SIR_HAL_ITC_MSG_TYPES_BEGIN + 158
