...
/**
  ...
  * Tue Aug 13 09:57:42 2013 from the following file(s):
  *
  * dot11f.frms
  *
...
typedef struct sDot11fFfMcastGroup {
    tANI_U8 mac[6];
} tDot11fFfMcastGroup;

#define DOT11F_FF_MCASTGROUP_LEN ( 6 )

void dot11fUnpackFfMcastGroup(tpAniSirGlobal, tANI_U8*, tDot11fFfMcastGroup*);

void dot11fPackFfMcastGroup(tpAniSirGlobal, tDot11fFfMcastGroup*, tANI_U8*);
...
typedef struct sDot11fRMC{
    ...
    tDot11fFfAction      Action;
    tDot11fFfDialogToken DialogToken;
    tDot11fFfMcastGroup  McastGroup;
} tDot11fRMC;
