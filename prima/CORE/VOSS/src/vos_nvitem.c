...
const tRfChannelProps rfChannels[NUM_RF_CHANNELS] =
{
    ...
    { 0   , 3  , NUM_RF_SUBBANDS},           //RF_CHAN_BOND_3,
    { 0   , 4  , NUM_RF_SUBBANDS},           //RF_CHAN_BOND_4,
    { 0   , 5  , NUM_RF_SUBBANDS},           //RF_CHAN_BOND_5,
    { 0   , 6  , NUM_RF_SUBBANDS},           //RF_CHAN_BOND_6,
    { 0   , 7  , NUM_RF_SUBBANDS},           //RF_CHAN_BOND_7,
    { 0   , 8  , NUM_RF_SUBBANDS},           //RF_CHAN_BOND_8,
    { 0   , 9  , NUM_RF_SUBBANDS},           //RF_CHAN_BOND_9,
    { 0   , 10  , NUM_RF_SUBBANDS},          //RF_CHAN_BOND_10,
    { 0   , 11  , NUM_RF_SUBBANDS},          //RF_CHAN_BOND_11,
    { 0   , 242 , NUM_RF_SUBBANDS},          //RF_CHAN_BOND_242,
    { 0   , 246 , NUM_RF_SUBBANDS},          //RF_CHAN_BOND_246,
    { 0   , 250 , NUM_RF_SUBBANDS},          //RF_CHAN_BOND_250,
    { 0   , 210 , NUM_RF_SUBBANDS},          //RF_CHAN_BOND_210,
    { 0   , 214 , NUM_RF_SUBBANDS},          //RF_CHAN_BOND_214,
