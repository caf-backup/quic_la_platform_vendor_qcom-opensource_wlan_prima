/** ------------------------------------------------------------------------- *
    ...
    \brief This header holds exposed types that are in common to configuration/Nv and
...
#define NUM_AGC_GAINS   80
typedef tRxGain sAgcGainLut[NUM_AGC_GAINS];

// typedef tANI_S8 tRxGainShift;   // +/- dB shift from rx0
// typedef struct
// {
//     tRxGainShift rx1;       // shift in relation to rx0
//     tANI_U8 unused[3];
// }tRxGainShiftChannel;
...
// KEEPING THESE TYPES IN CASE THEY ARE NEEDED IN THE FUTURE
