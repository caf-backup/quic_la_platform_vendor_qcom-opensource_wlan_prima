...
eHalStatus asicOverrideAGCRxChainGain(tpAniSirGlobal pMac, ePhyRxChains rxChain, tANI_U8 gain)
{
    ...
    switch (rxChain)
    {
        ...
        case PHY_RX_CHAIN_1:
            SET_PHY_REG(pMac->hHdd, QWLAN_AGC_GAINSET1_REG, ((tANI_U8 )gain | QWLAN_AGC_GAINSET1_OVERRIDE_MASK));
            break;
        ...
        case PHY_ALL_RX_CHAINS:
            {
                ...
                gainVal[0] = ((tANI_U8 )gain | QWLAN_AGC_GAINSET0_OVERRIDE_MASK);
                gainVal[1] = ((tANI_U8 )gain | QWLAN_AGC_GAINSET1_OVERRIDE_MASK);

                SET_PHY_MEMORY(pMac->hHdd, QWLAN_AGC_GAINSET0_REG, gainVal, 2);
            }
            break;
...
eHalStatus asicCeaseOverrideAGCRxChainGain(tpAniSirGlobal pMac, ePhyRxChains rxChain)
{
    ...
    switch (rxChain)
    {
        ...
        case PHY_RX_CHAIN_1:
            SET_PHY_REG(pMac->hHdd, QWLAN_AGC_GAINSET1_REG, 0);
            break;
