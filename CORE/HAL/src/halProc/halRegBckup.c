...
tRegisterEntry PreBBRegList[] = {
    ...
    { (HAL_REG_REINIT_WAIT_CMD | HAL_REG_RSVD_BIT | HAL_REG_HOST_FILLED),  200 },
    ...
    { (QWLAN_SPIM_CONTROL_REG | HAL_REG_RSVD_BIT | HAL_REG_HOST_FILLED),  0x840e },
    { (HAL_REG_REINIT_WAIT_CMD | HAL_REG_RSVD_BIT | HAL_REG_HOST_FILLED),  20 },
...
{ (QWLAN_RFAPB_MODE_SEL1_REG | HAL_REG_RSVD_BIT | HAL_REG_HOST_FILLED), 1,  0x4200 },
{ (QWLAN_RFAPB_REV_ID_REG | HAL_REG_RSVD_BIT | HAL_REG_HOST_FILLED), 1,  0x0 },
...
#if 0
{ (QWLAN_RFAPB_BB_BW1_REG | HAL_REG_RSVD_BIT | HAL_REG_FW_FILLED | HAL_REG_FW_EXTRA_FILLED), 1,  0x0 },
{ (QWLAN_RFAPB_BB_BW2_REG | HAL_REG_RSVD_BIT | HAL_REG_FW_FILLED | HAL_REG_FW_EXTRA_FILLED), 1,  0x0 },
{ (QWLAN_RFAPB_BB_BW3_REG | HAL_REG_RSVD_BIT | HAL_REG_FW_FILLED | HAL_REG_FW_EXTRA_FILLED), 1,  0x0 },
{ (QWLAN_RFAPB_BB_BW4_REG | HAL_REG_RSVD_BIT | HAL_REG_FW_FILLED | HAL_REG_FW_EXTRA_FILLED), 1,  0x0 },
{ (QWLAN_RFAPB_BB_BW5_REG | HAL_REG_RSVD_BIT | HAL_REG_FW_FILLED | HAL_REG_FW_EXTRA_FILLED), 1,  0x0 },
{ (QWLAN_RFAPB_BB_BW6_REG | HAL_REG_RSVD_BIT | HAL_REG_FW_FILLED | HAL_REG_FW_EXTRA_FILLED), 1,  0x0 },
#endif
