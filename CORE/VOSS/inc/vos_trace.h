...
// This compiles in or out all of the code generated by VOS_TRACE macro
// invocations.  Leave this defined to keep the VOS_TRACE Code compiled in.
// Remove this #define to cause the code for VOS_TRACE to be compiled out.
