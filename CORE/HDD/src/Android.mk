...
WLAN_FTM_OUT := vendor/qcom-proprietary/wlan/CORE/HDD/src/libra_ftm.o
...
$(WLAN_FTM_OUT):  $(KERNEL_OUT) $(KERNEL_CONFIG) $(TARGET_PREBUILT_KERNEL) $(WLAN_OUT)
	$(MAKE) -C kernel M=../vendor/qcom-proprietary/wlan/CORE/HDD/src O=../$(KERNEL_OUT) ARCH=arm CROSS_COMPILE=arm-eabi- BUILD_FTM_DRIVER=1
...
$(WLAN_FTM_PRODUCT_OUT): $(WLAN_FTM_OUT) $(MAKE_MODULES_FOLDER)
	$(ACP) -f out/target/product/$(TARGET_PRODUCT)/obj/vendor/qcom-proprietary/wlan/CORE/HDD/src/libra_ftm.ko $(WLAN_FTM_PRODUCT_OUT)
...
all: $(WLAN_OUT) $(WLAN_FTM_OUT) $(WLAN_PRODUCT_OUT) $(WLAN_FTM_PRODUCT_OUT) $(WLAN_LIBRA_SDIOIF_OUT)
