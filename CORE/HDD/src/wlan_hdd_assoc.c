      ...
      else
      {
		...
		*/
        ...
        if( !pRoamInfo->fReassocReq )
        {
            ...
            sme_RoamGetSecurityReqIE(pAdapter->hHal, &reqRsnLength, reqRsnIe, eCSR_SECURITY_TYPE_WPA);

            sme_RoamGetSecurityRspIE(pAdapter->hHal, &rspRsnLength, rspRsnIe, eCSR_SECURITY_TYPE_WPA);
