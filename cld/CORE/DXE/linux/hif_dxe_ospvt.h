 ...
 * @brief Provide  win os specific private functions/structures
 * @details
 *  This file Provides the  OS Private Layer used by Linux DXE OS Specific Module.
 */ 
/*========================================================================= 
    ...
    $Header:$   $DateTime: $ $Author: $ 
     ...
     --------		  ---			  --------------------------------------------------------
     03/05/13	  Ganesh Babu			 Created module.	      	  
==========================================================================*/
/*
